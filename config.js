...
// set true to enable anti-delete: recovers deleted messages and sends to your DM
AUTO_BIO: process.env.AUTO_BIO || "false",
// set true to auto-update your WhatsApp bio with uptime/time
AUTO_BIO_TEXT: process.env.AUTO_BIO_TEXT || "🏹 Hunter XMD Pro | ⏱ {uptime} | 🕒 {time}",
// bio template: use {uptime} {time} {date} {botname}
